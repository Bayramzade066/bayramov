...
function App() {
  ...
  return (
    <>
      ...
      <div className=" flex items-center justify-center bg-emerald-900">
        <div className=" w-full h-full sm:min-w-[1100px] sm:min-h-[650px] sm:w-[60%] sm:h-[60%] p-5 rounded-lg bg-zinc-700 shadow-xl block sm:fixed">
          {/* navbar */}
          ...
          <div className=" flex flex-col sm:flex-row h-[150px] sm:h-[30px] text-center px-5 gap-3 sm:gap-0 ">
            ...
            <span
              className="text-xl sm:text-lg bg-green-900  hover:bg-green-700 rounded-lg text-neutral-300 font-bold hover:text-neutral-600 transition-all hover:transition-all cursor-pointer w-auto pt-3 sm:pt-[4px] py-3 px-4"
              onClick={() => {
                setSection(4);
              }}
            >
          ...
          {section === 0 && (
            <div className="w-full h-full sm:gap-16 flex flex-col sm:flex-row items-center justify-center">
              <div className=" w-[80%] h-[25%] my-10 sm:my-0 sm:w-[40%] sm:h-[80%] sm:w-1/2  glitch shadow-2xl rounded-lg bg-cover bg-no-repeat bg-center w-full"></div>
              <div className="sm:w-1/2 h-[80%] flex flex-col justify-start sm:justify-center gap-5">
                ...
                <div className="flex flex-col items-center justify-end h-[100px] sm:h-full w-full">
                  ...
                  <AudioPlayer src="/getLucky.mp3" volume={0.3} />
                </div>
              </div>
            </div>
          )}
                ...
                <div className="w-full flex flex-col h-[60%] sm:h-full gap-10 sm:gap-10">
                  <div className="w-full flex flex-col sm:flex-row items-start justify-center gap-10 sm:gap-20">
                    <div className="flex items-center justify-center rounded-lg h-[25px] w-full sm:w-[35%]  block">
                      <span className="text-green-600 text-lg w-full font-bold">
                        Javascript -
                      </span>
                      <div className="w-full h-4 bg-neutral-300 rounded-full">
                        <div className="w-[80%] h-full text-center text-xs text-white bg-emerald-900 rounded-full"></div>
                      </div>
                    </div>
                    <div className="flex items-center justify-center rounded-lg h-[25px] w-full sm:w-[35%]  block">
                      <span className="text-green-600 text-lg w-full font-bold">
                      ...
                      <div className="w-full h-4 bg-neutral-300 rounded-full">
                        <div className="w-[85%] h-full text-center text-xs text-white bg-emerald-900 rounded-full"></div>
                      </div>
                    </div>
                  </div>
                  <div className="w-full flex flex-col sm:flex-row items-start justify-center gap-10 sm:gap-20">
                    <div className="flex items-center justify-center rounded-lg h-[25px] w-full sm:w-[35%]  block">
                      ...
                      <div className="w-full h-4 bg-neutral-300 rounded-full">
                        <div className="w-[65%] h-full text-center text-xs text-white bg-emerald-900 rounded-full"></div>
                      </div>
                    </div>
                    <div className="flex items-center justify-center rounded-lg h-[25px] w-full sm:w-[35%]  block">
                      <span className="text-green-600 text-lg w-full font-bold">
                      ...
                      <div className="w-full h-4 bg-neutral-300 rounded-full">
                        <div className="w-[70%] h-full text-center text-xs text-white bg-emerald-900 rounded-full"></div>
                      </div>
                    </div>
                  </div>
                  <div className="w-full flex flex-col sm:flex-row items-start justify-center gap-10 sm:gap-20">
                    <div className="flex items-center justify-center rounded-lg h-[25px] w-full sm:w-[35%]  block">
                      ...
                      <div className="w-full h-4 bg-neutral-300 rounded-full">
                        <div className="w-[55%] h-full text-center text-xs text-white bg-emerald-900 rounded-full"></div>
                      </div>
                    </div>
                    <div className="flex items-center justify-center rounded-lg h-[25px] w-full sm:w-[35%]  block">
                      <span className="text-green-600 text-lg w-full font-bold">
                      ...
                      <div className="w-full h-4 bg-neutral-300 rounded-full">
                        <div className="w-[30%] h-full text-center text-xs text-white bg-emerald-900 rounded-full"></div>
                      </div>
                    </div>
                  </div>
                  <div className="w-full flex flex-col sm:flex-row items-start justify-center gap-10 sm:gap-20">
                    <div className="flex items-center justify-center rounded-lg h-[25px] w-full sm:w-[35%]  block">
                      ...
                      <div className="w-full h-4 bg-neutral-300 rounded-full">
                        <div className="w-[90%] h-full text-center text-xs text-white bg-emerald-900 rounded-full"></div>
                      </div>
                    </div>
                    <div className="flex items-center justify-center rounded-lg h-[25px] w-full sm:w-[35%]  block">
                      <span className="text-green-600 text-lg w-full font-bold">
          ...
          {section === 3 && (
            <div className="w-full h-full sm:gap-16 flex flex-col sm:flex-row items-center justify-center sm:px-5">
              <div className="sm:w-1/2 h-[50%] sm:h-[80%] flex flex-col items-start justify-center sm:justify-center gap-5 border-b sm:border-b-0 sm:border-r border-emerald-800 py-5 sm:py-0">
                <span className="text-xl sm:text-2xl tracking-wide text-neutral-300 font-bold w-auto h-auto pt-20 sm:pt-0 mb-2 sm:mb-0">
                  Work experience
                </span>
                <div className="">
                  <span className="text-md sm:text-md tracking-wide text-neutral-200 font-bold w-auto h-auto mb-5 sm:mb-0">
                    ...
                    Developer -
                    <span className="text-green-600">2022 / Now</span>
                  </span>
                </div>
              </div>
              <div className="sm:w-1/2 h-[80%] flex flex-col justify-start sm:justify-start gap-5 ">
                ...
                <div className="">
                  <span className="text-md sm:text-md tracking-wide text-neutral-200 font-bold w-auto h-auto mb-5 sm:mb-0">
                    ...
                    >
                      Pragmatech education center's web site (Real project)
                    </a>
                    <br /> <br />- <a
                      target="_blank"
